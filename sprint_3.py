...
class TestRegistration:
    def test_success_registration (self):
        ...
        login_fields = driver.find_elements(By.XPATH, locators.input_fields_for_reg)
        login_fields[0].send_keys("Liudmila")
        login_fields[1].send_keys("liudmila_maksimenko_01_123@yandex.ru")
        login_fields[2].send_keys("123456789")
...
class TestNavigation:
    ...
    def test_go_to_buns_section(self):
        ...
        element = WebDriverWait(driver, 3).until(ec.visibility_of_element_located((By.XPATH, locators.cards_with_buns)))
        assert element

    def test_go_to_sauses_section(self):
        driver = common_functions.start_browser()
        driver.find_element(By.XPATH, locators.sauses_section_in_constructor).click()
        element = WebDriverWait(driver, 3).until(ec.visibility_of_element_located((By.XPATH, locators.cards_with_sauses)))
        assert element

    def test_go_to_fillings_section(self):
        driver = common_functions.start_browser()
        driver.find_element(By.XPATH, locators.fillings_section_in_constructor).click()
        element = WebDriverWait(driver, 3).until(ec.visibility_of_element_located((By.XPATH, locators.cards_with_fillings)))
        assert element